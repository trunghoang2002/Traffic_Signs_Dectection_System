...
#     'tv',
# )
VOC_BBOX_LABEL_NAMES = ("102", "106b", "123a", "123b", "127", "128", "130", "131a", "207b", "225", "245a", "407a")
...
def view_img(img, bbox, label=None, score=None, ax=None):
    ...
    for i, bb in enumerate(bbox):
        img = cv2.rectangle(img, (round(bb[1]), round(bb[0])), (round(bb[3]), round(bb[2])), color=(0, 255, 0), thickness=2)
        ...
        if len(caption) > 0:
            cv2.putText(img, ': '.join(caption), (round(bb[1]), round(bb[0])), cv2.FONT_HERSHEY_SIMPLEX, 1, color=(0, 255, 0))
    return img
